// An SSE **handler** in TypeScript (server-side) — the twin of sse-ticker. Returns a
// Response whose body is a ReadableStream of `data:` events; the js-http-runner pulls
// each chunk and flushes it incrementally (true streaming). A server handler, not a
// client `fetch`.
