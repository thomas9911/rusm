...
| [`ws_bench`](./ws_bench/) | **WebSocket** stress: hold many concurrent connections, echo round-trips — the stability-under-load proof. | `cargo run --release -p rusm-bench --example ws_bench` |
